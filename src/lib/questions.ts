...
export const questions: Question[] = [
  ...
  // Screen
  {
    ...
    options: [
      { label: "Scroll social media or TikTok", score: 0 },
      { label: "Text friends or scroll group chats", score: 0.2 },
  ...
  // Diet
  {
    ...
    options: [
      ...
      { label: "Random — whatever was around, no real plan", score: 0.2 },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Coffee or tea (with sugar/cream)", score: 0.5 },
